...
export const ProductPagePackaging = ({type, onChangeType, packagingBoxes, setExamplePhotoToggle, backgroundPageScrollOff}) => (
                    ...
                    return (
                        <div key={i.id}>
                            <div className='product-page__packaging--item'>
                                <div className='description product-page__radio' onClick={() => onChangeType(i.id)}>
