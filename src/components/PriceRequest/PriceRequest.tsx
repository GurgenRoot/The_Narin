...
import type { PackagingBoxesType } from '../../pages/ProductPage/db';

interface TPriceRequestProps {
  type: number,
  onChangeType: (id: number) => void,
  setPriceRequestToggle: (toggle: boolean) => void,
  packagingBoxes: Array<PackagingBoxesType>,
  backgroundPageScrollOn: () => void
}

const PriceRequest: FC<TPriceRequestProps> = ({
  type,
  onChangeType,
    ...
    <div className="price-request">
        ...
        <div className="price-request__title align-center">
          <div className="price-request__close">
            ...
            <img
              ...
              src={closeImg}
              alt="X"
              className="price-request__close--btn"
              onClick={() => {
        ...
        <div className="price-request__content--mobile">
          ...
          <div>
            ...
            <div className="description price-request__description">
              <div className="price-request__info">Season &ldquo;Lesser Armenia&rdquo;</div>
            </div>
            ...
            <div className="price-request__packaging">
              <div className="title">
                <div className="price-request__title--mobile">
                  ...
                  {packagingBoxes.map((i: PackagingBoxesType) => (
                    <div
                      key={i.id}
                      role="presentation"
                      className="price-request__packaging--btn"
                      onClick={() => onChangeType(i.id)}
                    >
      ...
      <div className="price-request__form">
        ...
        <div className="price-request__form--btn">
          <button
            className="btn price-request__btn"
            onClick={() => {
              setPriceRequestToggle(false);
              backgroundPageScrollOn();
            }}
