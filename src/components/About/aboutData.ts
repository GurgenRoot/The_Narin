...
export const aboutData = [
  {
    ...
    hideText: `We presented our first works in 2014. We were delighted that our customers have seen not just another
                        piece of luxury, but an object of art, with a rich history, behind which there are many peoples 
                        and great dynasties.`
  },
  {
    id: 'our-works',
