...
export const ProductSlider = ({collection, userDeviceScreenSize}) => {
  ...
  const handleSwipeLeft = () => {
    ...
    if (userDeviceScreenSize < 1280) {
      ...
      if (sliderLength === 200) {
        ...
        if (sliderLength === 300 && userDeviceScreenSize > 980 || sliderLength === 200 && userDeviceScreenSize < 980) return;
        setSliderLength(() => sliderLength - 100);
        setTranslateX(() => translateX + 100);
        setMr(() => mr - margin);
      }
