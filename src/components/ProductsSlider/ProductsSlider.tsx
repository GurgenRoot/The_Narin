...
const ProductSlider: FC<TProductSliderProps> = ({ collection, userDeviceScreenSize }) => {
  ...
  const mobile: number = userDeviceScreenSize - 323;

  const sz: number = userDeviceScreenSize > 668 ? desktop : mobile;
  const percent: number = sz / 307;

  const totalPercent: number = percent * 100;
