...
interface ProductBuyInfoType {
  setPriceRequestToggle: (priceRequest: boolean) => void,
  backgroundPageScrollOff: () => void
}

const ProductBuyInfo: FC<ProductBuyInfoType> = (
  { setPriceRequestToggle, backgroundPageScrollOff }
) => (
